...
window.addEventListener('scroll', () => {
    ...
    if (scrolled < heroHeight) {
        energyCircles.forEach((circle, index) => {
            ...
            circle.style.transform = `scale(${1 + (scrolled * 0.0002)}) rotate(${scrolled * speed * 0.1}deg)`;
        });
    }
});
...
// ===================================
console.log('%c🚀 Versat Prime', 'font-size: 24px; font-weight: bold; color: #00d4ff;');
console.log('%cWebsite desenvolvido com tecnologia de ponta', 'font-size: 14px; color: #a8b2d1;');
console.log('%c📧 contato@versatprime.com.br', 'font-size: 12px; color: #6b7280;');
